                ...
                <div class="col-6 col-md-3">
                    <div class="stat-card d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="stat-number">{{ $applications->total() ?? 0 }}</div>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" id="globalSearch" class="form-control border-start-0 ps-0" placeholder="Search by name, reference, email..." value="{{ request('search') }}">
                            ...
                            <div class="col-6 col-md-3">
                                <select name="residency_type" class="form-select">
                                    ...
                                    <option value="permanent" {{ request('residency_type') == 'permanent' ? 'selected' : '' }}>Permanent</option>
                                    <option value="temporary" {{ request('residency_type') == 'temporary' ? 'selected' : '' }}>Temporary</option>
                                </select>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex gap-1 gap-sm-2 justify-content-end">
                                            ...
                                            <form method="POST" action="{{ route('residency.approve', $app->id) }}" style="display: inline;">
                                                @csrf
                                            ...
                                            @if($app->status == 'processing')
                                            <form method="POST" action="{{ route('residency.reject', $app->id) }}" style="display: inline;">
                                                @csrf
                                            ...
                                            <form method="POST" action="{{ route('residency.destroy', $app->id) }}" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="modal fade" id="addApplicationModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{ route('residency.store') }}">
                            @csrf
                            <div class="modal-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="years_residing" placeholder="Years">
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label class="form-label">Residency Type</label>
                                        <select class="form-select" name="residency_type">
