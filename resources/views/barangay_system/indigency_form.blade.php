...
<head>
    ...
    <title>Barangay Indigency Application Form</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    <div class="back-button-container container-fluid px-3 px-md-4">
        <a href="{{ route('indigency') }}" class="btn-back">
            <i class="fas fa-arrow-left"></i> Back to Indigency Info
        </a>
    </div>

    <!-- Page Header -->
    <div class="form-page-header container-fluid px-3 px-md-4">
        <h1 class="mb-3"><i class="fas fa-hand-holding-heart"></i> Barangay Indigency Application</h1>
        <p class="mb-0">Fill out the form below to apply for your Certificate of Indigency</p>
    </div>
    ...
    <section class="application-form-section container-fluid px-3 px-md-4" id="apply-form">
        <div class="container form-container px-0">
            <form id="requirementForm" method="POST" action="{{ route('indigency.store') }}" enctype="multipart/form-data" class="requirement-form" novalidate>
                ...
                <!-- STEP 1: PERSONAL INFORMATION (adapted for indigency, but same style) -->
                <div class="form-step active" id="step1">
                    ...
                    <div class="form-group full-width">
                        <label for="address"><i class="fas fa-home"></i> Complete Address *</label>
                        <textarea id="address" name="address" required rows="3" placeholder="House No., Street, Subdivision/Village, Barangay Hulo, Malabon City" class="form-control"></textarea>
                    ...
                    <div class="form-grid row g-3 mt-3">
                        <div class="form-group col-md-12">
                            ...
                            <select id="monthlyIncome" name="monthly_income" required class="form-control">
                                ...
                                <option value="8k-10k">₱8,001 – ₱10,000</option>
                                <option value="10k-15k">₱10,001 – ₱15,000</option>
                                <option value="no income">No fixed income</option>
                            </select>
                            <div class="form-hint">Indigency is typically for low income / no income</div>
                        </div>
                        <div class="form-group col-md-12">
                            <label for="householdMembers"><i class="fas fa-users"></i> Number of Household Members *</label>
                            <input type="number" id="householdMembers" name="household_members" min="1" max="20" step="1" inputmode="numeric" pattern="[0-9]*" required placeholder="e.g., 4" class="form-control">
                        </div>
                    </div>

                    <div class="form-actions row g-2 btns">
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('indigency') }}" class="btn-prev" style="text-decoration: none; display: inline-flex; align-items: center; gap: 8px;" onclick="return confirm('Are you sure you want to cancel? Any unsaved changes will be lost.');">
                ...
                <div class="form-step" id="step2">
                    ...
                    <!-- PURPOSE (specific for indigency) -->
                    <div class="form-group mt-4">
                        <label for="purpose"><i class="fas fa-bullseye"></i> Purpose of Indigency Certificate *</label>
                        <select id="purpose" name="purpose" required class="form-control">
                            <option value="">Select purpose</option>
                            <option value="medical">Medical / Hospital assistance</option>
                            <option value="scholarship">Scholarship / Financial aid</option>
                            <option value="government">Government program (4Ps, AICS)</option>
                            <option value="legal">Legal assistance (PAO, etc.)</option>
                            <option value="employment">Employment requirement (low income proof)</option>
                ...
                <!-- STEP 3: REVIEW & SUBMIT (adapted for indigency) -->
                <div class="form-step" id="step3">
                    ...
                    <div class="review-section">
                        ...
                        <div class="review-card">
                            <h4><i class="fas fa-receipt"></i> Fee & Pickup (Indigency is usually free)</h4>
                            <div class="review-content">
                                <div class="payment-summary">
                                    <div class="payment-item">
                                        <span>Certificate of Indigency Fee</span>
                                        <span style="text-align: end;">₱0.00 (Free)</span>
                                    </div>
                                    <div class="payment-item">
                                ...
                                <div class="pickup-instructions">
                                    <div class="pickup-info">
                                        ...
                                        <div>
                                            <h5><i class="fas fa-building"></i> Payment & Pickup Location</h5>
                                            <p>Barangay Hulong Duhat Hall<br>1 M. Blas St, Malabon, Metro Manila</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pickup-info">
                                        ...
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                <li>Printed Reference Number (if possible)</li>
                    ...
                    <!-- benefits (similar, but indigency-focused) -->
                    <div class="benefits-section">
                        <h4><i class="fas fa-star"></i> Benefits of Online Indigency Request</h4>
                        <div class="benefits-grid row g-12">
                            ...
                            <div class="benefit-item col-md-4 col-sm-6">
                                ...
                                <h5>Pre-verified</h5>
                                <p class="mb-0">Your low-income status is pre-assessed</p>
                            </div>
                            <div class="benefit-item col-md-4 col-sm-6">
                                <i class="fas fa-bolt mb-3"></i>
                                <h5>Free of Charge</h5>
                                <p class="mb-0">Indigency certificates are free</p>
                            </div>
                        </div>
                    </div>

                    <!-- TERMS (checkbox similar, but indigency wording) -->
                    <div class="terms-section">
                        <label class="terms-checkbox">
                            <input type="checkbox" id="terms" name="terms" required>
                            <span class="checkmark"></span>
                            I hereby certify that all information provided is true and correct, and my income qualifies as low income based on barangay guidelines.
                        </label>
                        <label class="terms-checkbox">
