...
<head>
    ...
    <title>Barangay Hulo - Indigency Certificate Request</title>
</head>
<body>
    <form method="post" action="{{ route('indigency.req')}}" enctype="multipart/form-data">
        @method("post")
        @csrf
        <table border=1>
            <tr>
        ...
        <br>
        <h1>INDIGENCY CERTIFICATE REQUEST</h1>
        <br>
