        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateReview() {
                ...
                documentInfo.innerHTML = `
                    ...
                    <div class="review-item">
                        <div class="review-label">Primary Proof</div>
                        <div class="review-value">${primaryFile ? '1 file uploaded' : 'Not uploaded'}</div>
                    </div>
                    <div class="review-item">
                        <div class="review-label">Government ID</div>
                        <div class="review-value">${govIdFile ? '1 file uploaded' : 'Not uploaded'}</div>
                    </div>
                    <div class="review-item">
                        <div class="review-label">Previous Clearance</div>
                        <div class="review-value">${barangayFile ? '1 file uploaded' : 'Not uploaded (optional)'}</div>
                    </div>
                `;
            }
